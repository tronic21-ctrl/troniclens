...
function formatDuration(seconds: any) {
  ...
  if (s < 31536000)
    return `${Math.floor(s / 2592000)}mo ${Math.floor((s % 2592000) / 86400)}d`;
  return `${Math.floor(s / 31536000)}y ${Math.floor(
    (s % 31536000) / 2592000
  )}mo`;
}
    ...
    >
      <motion.div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, #10b98130 0%, #10b98108 50%, transparent 70%)",
          filter: "blur(48px)",
      ...
      <motion.div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, #38bdf820 0%, #38bdf808 50%, transparent 70%)",
          filter: "blur(56px)",
          willChange: "transform, opacity",
        }}
      />
      ...
      >
        <motion.div
          ...
          style={{
            ...
            height: "100%",
            background:
              "linear-gradient(90deg, transparent, #ffffff15, transparent)",
            pointerEvents: "none",
          }}
        />
        Connect Wallet
...
export default function StakeActionContent({
  onGoToGovernance,
}: StakeActionProps) {
  ...
  }, [stakeSuccess, unstakeSuccess, refetchStakeInfo, refetchReward]);
  ...
  const inputValid = !!(
    stakeInput &&
    parseFloat(stakeInput) >= minEth &&
    balance &&
    parseFloat(stakeInput) <= parseFloat(formatEther(balance.value))
  );

  return (
    <div
      style={{
        padding: isMobile ? "12px 10px" : compact ? "16px" : "24px 32px",
        position: "relative",
        minHeight: "100vh",
        overflowX: "hidden",
      }}
      ...
      >
        ...
        <div style={{ marginBottom: compact ? "16px" : "20px" }}>
          ...
          <p style={{ color: COLORS.textMuted, fontSize: "13px", margin: 0 }}>
            Stake assets to earn rewards and unlock voting power in TronicLens
            Governance
          </p>
        </div>
        ...
        {!isConnected ? (
          ...
          <>
            ...
            >
              ...
              >
                <p style={{ color: COLORS.textMuted, fontSize: "12px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em", margin: 0 }}>
                  Your Stake
                </p>
                <p style={{ color: COLORS.text, fontSize: "32px", fontWeight: 700, fontFamily: "var(--font-sans)", letterSpacing: "-0.02em", margin: "8px 0" }}>
                  {formatEth(stakedAmount)} <span style={{ fontSize: "50%", color: COLORS.textMuted, fontWeight: 600 }}>ETH</span>
                </p>
                <p style={{ color: COLORS.textDim, fontSize: "13px", margin: "0 0 16px" }}>
                  {hasStake ? "Active position" : "No active stake"}
                </p>
                <div style={{ paddingTop: "16px", borderTop: `1px solid ${COLORS.cardBorder}` }}>
                  <p style={{ color: COLORS.textMuted, fontSize: "11px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em", margin: 0 }}>
                    Accrued Reward
                  </p>
                  <p style={{ color: COLORS.green, fontSize: "16px", fontWeight: 600, margin: "4px 0 0" }}>
                    {formatEth(currentReward)} ETH
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <p style={{ color: COLORS.text, fontSize: "24px", fontWeight: 700, fontFamily: "var(--font-sans)", margin: "8px 0" }}>
                  {hasStake ? formatDuration(stakeInfo?.[2]) : "—"}
                </p>
                <p style={{ color: COLORS.textDim, fontSize: "13px", margin: 0 }}>
                  {hasStake ? "Time staked" : "Not staking"}
                </p>
              </div>
            </div>
              ...
              <span style={{ color: "#4a5568", fontSize: "11px", fontFamily: "monospace" }}>
                {contractBalance && rewardData !== undefined
                  ? (() => {
                      ...
                      const ratePerYear = BigInt(Math.floor(ratePerSec * 1e18)) * BigInt(31536000);
                ...
                <AnimatePresence mode="wait">
                  {tab === "stake" ? (
                    ...
                    >
                        ...
                        <div style={{ position: "relative" }}>
                          <input
                            ...
                            style={{
                              ...
                              backgroundColor: COLORS.card,
                              border: `1px solid ${
                                inputValid ? COLORS.cyan + "60" : COLORS.cardBorder
                              }`,
                              borderRadius: "8px",
                              color: COLORS.text,
                              fontSize: "15px",
                      ...
                      <motion.button
                        whileHover={{
                          scale: inputValid ? 1.03 : 1,
                          boxShadow: inputValid ? "0 0 24px #10b98135" : "none",
                        }}
                        ...
                        <>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                {parseFloat(
                                  formatEther(stakedAmount + currentReward)
                                ).toFixed(10)}{" "}
                                ETH
                              </span>
                            </div>
            ...
            >
              ...
              >
                ...
                Stake any amount above the minimum to start earning rewards
                automatically. Your staked ETH also grants you voting power in
                Governance — the more you stake, the more weight your vote carries.
                Unstaking returns your full principal plus accrued rewards.
              </p>
            </motion.div>
          </>
        )}
