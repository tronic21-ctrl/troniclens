          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            >
              {isPrice ? (
                ...
                <svg width="24" height="20" viewBox="0 0 576 512" fill={accentColor}>
                  <path d="M312 256.4V296c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24V256.4c0-101.9 66-189 162.9-218C183.1 32 208 32 208 32h72c13.3 0 24 10.7 24 24s-10.7 24-24 24H208v16c0 26.5 21.5 48 48 48h56zM501.9 146.5c-4 3.9-9.5 6.3-15.6 6.3H408c-8.8 0-16 7.2-16 16v136.2l-38.3 35.7c-9 8.4-21.2 13.1-33.8 13.1H32C14.3 353.7 0 368 0 385.7c0 39.9 32.4 72.3 72.3 72.3h104v13.6c0 22.3 18.1 40.4 40.4 40.4s40.4-18.1 40.4-40.4V458h212.9c36.7 0 62.3-35.8 48.6-70L464.3 241.1l74.9-74.9c4.2-4.2 6.5-9.8 6.5-15.7s-2.3-11.5-6.5-15.7l-15.3-15.3c-6.1-6.1-16-6.1-22 0z" />
                </svg>
              )}
            </span>
            <div>
